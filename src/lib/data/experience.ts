...
export const items: Array<Experience> = [
	...
	},
	{
		...
		location: 'Carson, CA',
		period: { from: new Date(2024, 5, 1), to: new Date(2024, 7, 1) },
		skills: getSkills(),
	...
	},
	{
		...
		type: 'Pharmaceutical Supply Chain',
		location: 'Carson, CA',
		period: { from: new Date(2023, 4, 1), to: new Date(2024, 5, 1) },
		skills: getSkills(),
	...
	},
	{
		...
		period: { from: new Date(2022, 2, 1), to: new Date(2023, 3, 1) },
		skills: getSkills(),
	...
	},
	{
		...
		period: { from: new Date(2021, 9, 1), to: new Date(2022, 11, 1) },
		skills: getSkills(),
	...
	},
	{
		...
		type: 'Transportation',
		location: 'Compton, CA',
		period: { from: new Date(2020, 2, 1), to: new Date(2021, 9, 1) },
		skills: getSkills(),
