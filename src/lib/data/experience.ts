...
export const items: Array<Experience> = [
	...
	},
	{
		...
		type: 'Test Automation',
		location: 'Home',
		period: { from: new Date(2023, 3, 1), to: new Date(2023, 10, 1) },
		skills: getSkills('java', 'selenium', 'mybatis', 'junit', 'aws', 'css', 'html'),
	...
	},
	{
		...
		location: 'Carson, CA',
		period: { from: new Date(2024, 4, 1), to: new Date(2024, 6, 1) },
		skills: getSkills(),
	...
	},
	{
		...
		type: 'Pharmaceutical Supply Chain',
		location: 'Carson, CA',
		period: { from: new Date(2023, 3, 1), to: new Date(2024, 4, 1) },
		skills: getSkills(),
	...
	},
	{
		...
		period: { from: new Date(2022, 1, 1), to: new Date(2023, 2, 1) },
		skills: getSkills(),
	...
	},
	{
		...
		period: { from: new Date(2021, 8, 1), to: new Date(2022, 10, 1) },
		skills: getSkills(),
	...
	},
	{
		...
		type: 'Transportation',
		location: 'Compton, CA',
		period: { from: new Date(2020, 1, 1), to: new Date(2021, 8, 1) },
		skills: getSkills(),
